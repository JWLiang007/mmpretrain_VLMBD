...
class VLMBackdoor(BaseMetric):
    ...
    def process(self, data_batch, data_samples):
        ...
        for data_sample in data_samples:
            ...
            if self.target in result['caption']:
                result['bd'] = 1
            else:
                result['bd'] = 0
    ...
    def compute_metrics(self, results: List):
        ...
        bd_num = np.array([item['bd'] for item in results]).sum()
        bd_ratio = bd_num / total_num
        return {'bd_ratio': bd_ratio}
